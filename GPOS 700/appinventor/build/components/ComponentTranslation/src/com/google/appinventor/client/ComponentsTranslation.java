...
/* Parameters */
    ...
    map.put("METHODDESC-ImpressoraOutputMethodDescriptions", MESSAGES.ImpressoraOutputMethodDescriptions());
    map.put("METHODDESC-ImprimirTextoMethodDescriptions", MESSAGES.ImprimirTextoMethodDescriptions());
    ...
    map.put("PROPDESC-LegacyModePropertyDescriptions", MESSAGES.LegacyModePropertyDescriptions());
    ...
    map.put("PROPDESC-avancaLinhaPropertyDescriptions", MESSAGES.avancaLinhaPropertyDescriptions());
    map.put("METHODDESC-doFaultMethodDescriptions", MESSAGES.doFaultMethodDescriptions());
    map.put("PROPDESC-getAlinhamentoPropertyDescriptions", MESSAGES.getAlinhamentoPropertyDescriptions());
    map.put("PROPDESC-getAvancaLinhasPropertyDescriptions", MESSAGES.getAvancaLinhasPropertyDescriptions());
    map.put("PROPDESC-getFontePropertyDescriptions", MESSAGES.getFontePropertyDescriptions());
    map.put("PROPDESC-getLineSpacePropertyDescriptions", MESSAGES.getLineSpacePropertyDescriptions());
    map.put("PROPDESC-getOffSetPropertyDescriptions", MESSAGES.getOffSetPropertyDescriptions());
    map.put("METHODDESC-getStatusImpressoraMethodDescriptions", MESSAGES.getStatusImpressoraMethodDescriptions());
    map.put("PROPDESC-getTamanhoPropertyDescriptions", MESSAGES.getTamanhoPropertyDescriptions());
    map.put("PROPDESC-getiHeightPropertyDescriptions", MESSAGES.getiHeightPropertyDescriptions());
    map.put("PROPDESC-getiWidthPropertyDescriptions", MESSAGES.getiWidthPropertyDescriptions());
    map.put("METHODDESC-imprimeBarCodeMethodDescriptions", MESSAGES.imprimeBarCodeMethodDescriptions());
    map.put("METHODDESC-imprimeImagemMethodDescriptions", MESSAGES.imprimeImagemMethodDescriptions());
    ...
    map.put("PROPDESC-isItalicoPropertyDescriptions", MESSAGES.isItalicoPropertyDescriptions());
    map.put("PROPDESC-isNegritoPropertyDescriptions", MESSAGES.isNegritoPropertyDescriptions());
    map.put("PROPDESC-isSublinhadoPropertyDescriptions", MESSAGES.isSublinhadoPropertyDescriptions());
    map.put("PROPDESC-setAlinhamentoPropertyDescriptions", MESSAGES.setAlinhamentoPropertyDescriptions());
    map.put("METHODDESC-setAssetsLoadedMethodDescriptions", MESSAGES.setAssetsLoadedMethodDescriptions());
    map.put("PROPDESC-setAvancaLinhasPropertyDescriptions", MESSAGES.setAvancaLinhasPropertyDescriptions());
    map.put("PROPDESC-setConfigImpressaoPropertyDescriptions", MESSAGES.setConfigImpressaoPropertyDescriptions());
    map.put("PROPDESC-setFontePropertyDescriptions", MESSAGES.setFontePropertyDescriptions());
    map.put("METHODDESC-setHmacSeedReturnCodeMethodDescriptions", MESSAGES.setHmacSeedReturnCodeMethodDescriptions());
    map.put("PROPDESC-setItalicoPropertyDescriptions", MESSAGES.setItalicoPropertyDescriptions());
    map.put("PROPDESC-setLineSpacePropertyDescriptions", MESSAGES.setLineSpacePropertyDescriptions());
    map.put("PROPDESC-setNegritoPropertyDescriptions", MESSAGES.setNegritoPropertyDescriptions());
    map.put("PROPDESC-setOffSetPropertyDescriptions", MESSAGES.setOffSetPropertyDescriptions());
    map.put("PROPDESC-setSublinhadoPropertyDescriptions", MESSAGES.setSublinhadoPropertyDescriptions());
    map.put("PROPDESC-setTamanhoPropertyDescriptions", MESSAGES.setTamanhoPropertyDescriptions());
    map.put("PROPDESC-setiHeightPropertyDescriptions", MESSAGES.setiHeightPropertyDescriptions());
    map.put("PROPDESC-setiWidthPropertyDescriptions", MESSAGES.setiWidthPropertyDescriptions());
