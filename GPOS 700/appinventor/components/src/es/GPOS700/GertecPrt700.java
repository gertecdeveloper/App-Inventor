...
@DesignerComponent(version = GertecPrt700.VERSION, description = "Gertec Funções", category = ComponentCategory.EXTENSION, nonVisible = true, iconName = "")

@SimpleObject(external = true)
@UsesLibraries(libraries = "br.jar")
public class GertecPrt700 extends AndroidNonvisibleComponent implements Component {
    ICL icl = null;
    ...
    public GertecPrt700(ComponentContainer container) {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                iGedi = GEDI.getInstance(my_container.$context());
